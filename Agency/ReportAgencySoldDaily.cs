...
namespace Agency
{
    public partial class ReportAgencySoldDaily : Form
    {
        ...
        public ReportAgencySoldDaily(AgencyBusiness AG)
        {
            InitializeComponent();
            ...
            if(EndDate>BeginDate){
                if (BeginDate > MinDate && BeginDate < MaxDate && EndDate > MinDate && EndDate < MaxDate)
                {
                    ...
                    if (difdate.Days <= 30)
                    {
                        ...
                        AgencyChart_DataSet = Agency.DayBase_AgencySoldDaily(BeginDate, EndDate, Agency.AgencyID);
        ...
        private void ReportAgencySoldDaily_Paint(object sender, PaintEventArgs e)
        {
