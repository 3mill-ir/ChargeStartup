...
namespace Agency
{
    public partial class ReportAgencySoldMonthly : Form
    {
        ...
        public ReportAgencySoldMonthly(AgencyBusiness AG)
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            AgencyChart_DataSet = Agency.MonthBase_AgencySoldDaily(BeginDate, EndDate, Agency.AgencyID);
        ...
        private void ReportAgencySoldMonthly_Paint(object sender, PaintEventArgs e)
        {
