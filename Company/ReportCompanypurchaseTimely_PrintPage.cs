...
namespace Company
{
    public partial class ReportCompanypurchaseTimely_PrintPage : Form
    {
        DataTable Printint_DT;
        public ReportCompanypurchaseTimely_PrintPage(DataTable dt)
        {
            InitializeComponent();
            Printint_DT = dt;
        }
        ...
        private void ReportCompanypurchaseDaily_PrintPage_Load(object sender, EventArgs e)
        {
            ...
            reportViewer1.LocalReport.ReportEmbeddedResource = "Company.ReportCompanypurchaseTimely_PrintTemplate.rdlc";
