...
namespace Company
{
    public partial class ReportAgencySoldMonthly_PrintPage : Form
    {
        DataTable Printint_DT;
        public ReportAgencySoldMonthly_PrintPage(DataTable dt)
        {
            InitializeComponent();
            Printint_DT = dt;
        }
        ...
        private void ReportCompanypurchaseDaily_PrintPage_Load(object sender, EventArgs e)
        {
            ...
            reportViewer1.LocalReport.ReportEmbeddedResource = "Company.ReportAgencySoldMonthly_PrintTemplate.rdlc";
