...
namespace Company
{
    public partial class ReportCompanySoldMonthly : Form
    {
        ...
        public ReportCompanySoldMonthly(CompanyBusiness CB)
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show(BeginDate.ToString() + "   " + EndDate.ToString());
                        ...
                        CompanyChart_DataSet = Company.MonthBase_CompanySoldDaily(BeginDate, EndDate);
        ...
        {
            ReportCompanySoldMonthly_PrintPage RCPD_PP = new ReportCompanySoldMonthly_PrintPage(CompanyChart_DataSet.Tables["WholeData_DT"]);
            RCPD_PP.Show();
        }
