...
namespace Company
{
    public partial class ReportCompanypurchaseDaily_PrintPage : Form
    {
        DataTable Printint_DT;
        public ReportCompanypurchaseDaily_PrintPage(DataTable dt)
        {
            InitializeComponent();
            Printint_DT = dt;
        }
        ...
        private void ReportCompanypurchaseDaily_PrintPage_Load(object sender, EventArgs e)
        {
            ...
            reportViewer1.LocalReport.ReportEmbeddedResource = "Company.ReportCompanypurchaseDaily_PrintTemplate.rdlc";
