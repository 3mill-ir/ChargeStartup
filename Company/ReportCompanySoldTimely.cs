...
namespace Company
{
    public partial class ReportCompanySoldTimely : Form
    {
        ...
        public ReportCompanySoldTimely(CompanyBusiness CB)
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            DateTime Date = faDatePicker1.SelectedDateTime;
                        ...
                        CompanyChart_DataSet = Company.TimeBase_CompanySoldDaily(Date);
                        Tab1Fill();
                        Tab2Fill();
                        Tab3Fill();
                        Tab4Fill();
        ...
        {
            ReportCompanySoldTimely_PrintPage RCPD_PP = new ReportCompanySoldTimely_PrintPage(CompanyChart_DataSet.Tables["WholeData_DT"]);
            RCPD_PP.Show();
        }
