...
namespace Company
{
    public partial class ReportAgencySoldMonthly : Form
    {
        ...
        public ReportAgencySoldMonthly(CompanyBusiness CB,Int64 AG_ID)
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show(BeginDate.ToString() + "   " + EndDate.ToString());
                        ...
                        CompanyChart_DataSet = Company.MonthBase_AgencySoldDaily(BeginDate, EndDate,AgencyID);
        ...
        {
            ReportAgencySoldMonthly_PrintPage RCPD_PP = new ReportAgencySoldMonthly_PrintPage(CompanyChart_DataSet.Tables["WholeData_DT"]);
            RCPD_PP.Show();
        }
