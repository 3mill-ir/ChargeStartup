...
namespace Company
{
    public partial class ReportCompanypurchaseMonthly_PrintPage : Form
    {
        DataTable Printint_DT;
        public ReportCompanypurchaseMonthly_PrintPage(DataTable dt)
        {
            InitializeComponent();
            Printint_DT = dt;
        }
        ...
        private void ReportCompanypurchaseDaily_PrintPage_Load(object sender, EventArgs e)
        {
            ...
            reportViewer1.LocalReport.ReportEmbeddedResource = "Company.ReportCompanypurchaseMonthly_PrintTemplate.rdlc";
