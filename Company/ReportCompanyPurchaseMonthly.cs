...
namespace Company
{
    public partial class ReportCompanyPurchaseMonthly : Form
    {
        ...
        public ReportCompanyPurchaseMonthly(CompanyBusiness CB)
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                PersianDate P_BeginDate = new PersianDate(Convert.ToInt32(comboBox1.SelectedItem), 1, 1);

                PersianDate P_EndDate = new PersianDate(Convert.ToInt32(comboBox1.SelectedItem) + 1, 1, 1);
          
            DateTime BeginDate =DateTime.Parse(PersianDateConverter.ToGregorianDate(P_BeginDate));
            DateTime EndDate =DateTime.Parse(PersianDateConverter.ToGregorianDate(P_EndDate));
            MessageBox.Show(BeginDate.ToString() + "   " + EndDate.ToString());
                  
                        CompanyChart_DataSet = Company.MonthBase_AllChargesInWhole(BeginDate, EndDate);
                ...
                pmb.show("لطفاً سال مورد نظر را انتخاب کنید.", "هشدار", PersianMessageBox.Warning, 1, "YES/NO");
            }
        ...
        {
            ReportCompanypurchaseMonthly_PrintPage RCPD_PP = new ReportCompanypurchaseMonthly_PrintPage(CompanyChart_DataSet.Tables["WholeData_DT"]);
            RCPD_PP.Show();
        }
