...
namespace Company
{
    public partial class ReportAgencySelectTimely : Form
    {
        CompanyBusiness Company;

        public ReportAgencySelectTimely(CompanyBusiness CB)
        {
            InitializeComponent();
            Company = CB;
            FillForm();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
           ...
           ReportAgencySoldTimely RAST = new ReportAgencySoldTimely(Company, username_int);
           RAST.Show();
