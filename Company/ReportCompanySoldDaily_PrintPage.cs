...
namespace Company
{
    public partial class ReportCompanySoldDaily_PrintPage : Form
    {
        DataTable Printint_DT;
        public ReportCompanySoldDaily_PrintPage(DataTable dt)
        {
            InitializeComponent();
            Printint_DT = dt;
        }
        ...
        private void ReportCompanypurchaseDaily_PrintPage_Load(object sender, EventArgs e)
        {
            ...
            reportViewer1.LocalReport.ReportEmbeddedResource = "Company.ReportCompanySoldDaily_PrintTemplate.rdlc";
