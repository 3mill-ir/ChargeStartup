...
namespace Company
{
    public partial class ReportCompanyPurchaseTimely : Form
    {
        ...
        public ReportCompanyPurchaseTimely(CompanyBusiness CB)
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            DateTime Date = faDatePicker1.SelectedDateTime;
                        ...
                        CompanyChart_DataSet = Company.TimeBase_AllChargesInWhole(Date);
                        Tab1Fill();
                        Tab2Fill();
                        Tab3Fill();
                        Tab4Fill();
        ...
        {
            ReportCompanypurchaseTimely_PrintPage RCPD_PP = new ReportCompanypurchaseTimely_PrintPage(CompanyChart_DataSet.Tables["WholeData_DT"]);
            RCPD_PP.Show();
        }
