...
namespace Company
{
    public partial class ReportAgencySelectMonthly : Form
    {
        CompanyBusiness Company;

        public ReportAgencySelectMonthly(CompanyBusiness CB)
        {
            InitializeComponent();
            Company = CB;
            FillForm();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
           ...
           ReportAgencySoldMonthly RASM = new ReportAgencySoldMonthly(Company, username_int);
           RASM.Show();
