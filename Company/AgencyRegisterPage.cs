...
namespace Company
{
    public partial class AgencyRegisterPage : Form
    {
        CompanyBusiness Company;
        bool ValidEmail;
        public AgencyRegisterPage(CompanyBusiness CB)
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (isAllFieldCompleted() && isValidBirthdate())
            {
                ...
                if (Company.AddNewAgency(username_int, tempPass, textBox1.Text, textBox2.Text, textBox3.Text, comboBox1.SelectedItem.ToString(), maskedTextBox1.Text, textBox4.Text, textBox5.Text, maskedTextBox3.Text, textBox6.Text, textBox7.Text, textBox11.Text, textBox8.Text, creditbalance_int, textBox10.Text, comboBox3.SelectedItem.ToString(), textBox12.Text, DateTime.Now,DateTime.Now,Company.UserID,true))
                {
                    PersianMessageBox pmb = new PersianMessageBox();
                    pmb.show("عملیات ثبت نام واحد فروش جدید با موفقیت انجام شد.", "موفقیت", PersianMessageBox.Information, 1, "OK");
                }
                else
                {
                    PersianMessageBox pmb = new PersianMessageBox();
                    pmb.show("مشکل در ثبت نام واحد جدید.", "خطا", PersianMessageBox.Error, 1, "OK");
                }
