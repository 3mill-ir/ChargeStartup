...
namespace Company
{
    public partial class AgencyShowPage : Form
    {
        ...
        public AgencyShowPage(CompanyBusiness CB, Int64 username)
        {
            InitializeComponent();
            Company = CB;
            ...
            AG_ID = username;
            dt = new DataTable();
            dt = Company.GetAgencyInformation(AG_ID);
            FormFill();
            InfoChanged = false;
        }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (isAllFieldCompleted() && isValidBirthdate())
            {
                ...
                string creditbalance_str = textBox9.Text+" ریال";
                ...
                RegisterdAgencyInformation_PrintPage RAIPP = new RegisterdAgencyInformation_PrintPage(Company.AgencyInformationPrint(username_int, tempPass, textBox1.Text, textBox2.Text, textBox3.Text, comboBox1.SelectedItem.ToString(), maskedTextBox1.Text, textBox4.Text, textBox5.Text, maskedTextBox3.Text, textBox6.Text, textBox7.Text, textBox11.Text, textBox8.Text, creditbalance_str, textBox10.Text, comboBox3.SelectedItem.ToString(), textBox12.Text, signupdate_str, DateTime.Now, Company.UserID, statues).Tables["AgencyInformationDT"]);
                RAIPP.Show();
