...
namespace Company
{
    public partial class ReportCompanySoldDaily : Form
    {
        ...
        public ReportCompanySoldDaily(CompanyBusiness CB)
        {
            InitializeComponent();
            ...
            if(EndDate>BeginDate){
                if (BeginDate > MinDate && BeginDate < MaxDate && EndDate > MinDate && EndDate < MaxDate)
                {
                    ...
                    if (difdate.Days <= 30)
                    {
                        ...
                        CompanyChart_DataSet = Company.DayBase_CompanySoldDaily(BeginDate, EndDate);
        ...
        {
            ReportCompanySoldDaily_PrintPage RCPD_PP = new ReportCompanySoldDaily_PrintPage(CompanyChart_DataSet.Tables["WholeData_DT"]);
            RCPD_PP.Show();
        }
