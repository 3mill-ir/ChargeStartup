...
namespace Company
{
    public partial class ReportAgencySoldDaily_PrintPage : Form
    {
        DataTable Printint_DT;
        public ReportAgencySoldDaily_PrintPage(DataTable dt)
        {
            InitializeComponent();
            Printint_DT = dt;
        }
        ...
        private void ReportCompanypurchaseDaily_PrintPage_Load(object sender, EventArgs e)
        {
            ...
            reportViewer1.LocalReport.ReportEmbeddedResource = "Company.ReportAgencySoldDaily_PrintTemplate.rdlc";
