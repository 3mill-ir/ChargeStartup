...
namespace Company
{
    public partial class ReportCompanySoldMonthly_PrintPage : Form
    {
        DataTable Printint_DT;
        public ReportCompanySoldMonthly_PrintPage(DataTable dt)
        {
            InitializeComponent();
            Printint_DT = dt;
        }
        ...
        private void ReportCompanypurchaseDaily_PrintPage_Load(object sender, EventArgs e)
        {
            ...
            reportViewer1.LocalReport.ReportEmbeddedResource = "Company.ReportCompanySoldMonthly_PrintTemplate.rdlc";
