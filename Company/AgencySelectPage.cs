...
namespace Company
{
    public partial class AgencySelectPage : Form
    {
        CompanyBusiness Company;

        public AgencySelectPage(CompanyBusiness CB)
        {
            InitializeComponent();
            Company = CB;
            FillForm();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            AgencyEditPage AEP = new AgencyEditPage(Company, username_int);
            AEP.Show();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            Int64 username_int = Int64.Parse(username_str);
            AgencyShowPage ASP = new AgencyShowPage(Company, username_int);
            ASP.Show();
        }
    }
}
